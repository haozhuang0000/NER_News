...
from ingestion.models import SentenceSplit, SelectedSentence, NERMapped
...
class SimilarityMapping(MilvusDB):
    ...
    def batch_helper(self, batch: list[SentenceSplit]):
        """
    ...
    def run(self, message_data: list[SentenceSplit]):
        try:
            ...
            raise Exception(
                f"SimilaritySearch: {e} occured with {split_sentence_records}"
            )
